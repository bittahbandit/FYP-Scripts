...
fig.text(0.5, 0.03, 'Oil Temperature', ha='center',fontsize=12)
fig.text(0.04, 0.5, 'IP Vibration Magnitude', va='center', rotation='vertical',fontsize=12)
